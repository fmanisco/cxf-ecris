...
/**
 * This types defines one-to-many relationships between one "decision" and one or more "offence" entities.
 * 
 * <p>Java class for DecisionToOffencesRelationshipType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="DecisionToOffencesRelationshipType">
 *   &lt;complexContent>
...
@XmlType(name = "DecisionToOffencesRelationshipType", propOrder = {
    "decision",
    "offence"
})
public class DecisionToOffencesRelationshipType
