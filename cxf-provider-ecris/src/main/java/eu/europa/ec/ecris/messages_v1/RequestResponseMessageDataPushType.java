 ...
 *                 and request response. The response type indicates the resulting response. It possibly includes the
 *                 fingerprints binary file (i.e. "push" implementation of the message).
 * 
 * <p>Java class for RequestResponseMessageDataPushType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="RequestResponseMessageDataPushType">
 *   &lt;complexContent>
...
@XmlType(name = "RequestResponseMessageDataPushType")
public class RequestResponseMessageDataPushType
